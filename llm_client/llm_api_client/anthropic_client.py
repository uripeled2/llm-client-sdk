...
class AnthropicClient(BaseLLMAPIClient):
    ...
    async def text_completion(self, prompt: str, model: Optional[str] = None, max_tokens: Optional[int] = None, temperature: float = 1,
                              **kwargs) -> \
            list[str]:
        ...
        kwargs["max_tokens_to_sample"] = kwargs.pop("max_tokens_to_sample", max_tokens)
